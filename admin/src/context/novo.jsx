...
export const ScheduleProvider = ({ children }) => { // Exportação do ScheduleProvider
  ...
  const { fetchRooms, changeRoomState } = useRoomProvider(setRooms, setLoading);
  ...
  const { lawyerFound,createLawyer, getLawyerByOab } = useLawyerProvider( setLawyer, setLoading);
